...
if (isset($_POST['BTN'])) {
    $UserInputArray = [
         //the user id will be changed to the logged in user id by using the session of logging in system
        //there are some data filedes will be added in the future and will also added in the database
        "UserID" => $_POST['UserID'],
